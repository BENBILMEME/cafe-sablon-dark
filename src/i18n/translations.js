export const translations = {
  tr: {
    nav: { menu: 'Menü', process: 'Sürecimiz', location: 'Moda', contact: 'İletişim', directions: 'Yol Tarifi' },
    ...
    process: { title: 'Artisan Süreç', heading: '72 Saatlik Yolculuk', desc: 'Endüstriyel hızın aksine, biz her kruvasana tam 3 gün emek veriyoruz.' },
    ...
    footer: { rights: 'Tüm hakları saklıdır.', privacy: 'Gizlilik Politikası', terms: 'Kullanım Koşulları', location: 'Caferağa Mah. Moda Cad. No:42/B, Kadıköy — İstanbul' },
    ...
    categories: { savory: 'Tuzlular', sweet: 'Tatlılar', drinks: 'İçecekler' },
    lang: 'TR',
  },
  en: {
    nav: { menu: 'Menu', process: 'Our Process', location: 'Moda', contact: 'Contact', directions: 'Directions' },
    ...
    process: { title: 'Artisan Process', heading: '72-Hour Journey', desc: 'Unlike industrial speed, we dedicate 3 full days to every croissant.' },
    ...
    footer: { rights: 'All rights reserved.', privacy: 'Privacy Policy', terms: 'Terms of Use', location: 'Caferağa Mah. Moda Cad. No:42/B, Kadıköy — İstanbul' },
    ...
    categories: { savory: 'Savory', sweet: 'Sweet', drinks: 'Drinks' },
    lang: 'EN',
  },
};
...
export const menuTranslations = {
  tr: {
    ...
    'danish-boat': { name: 'Danish Boat', desc: 'Danimarka hamurundan tekne, orman meyveleri, badem, pudra şekeri' },
    'croissant-sandwich': { name: 'Croissant Sandwich', desc: '72 saatlik kruvasan arası özel sandviç, taze malzemeler' },
    'fresh': { name: 'Fresh Bowl', desc: 'Mevsim meyveleri, granola, yoğurt, bal' },
    'pistachio-croissant': { name: 'Pistachio Croissant', desc: 'Antep fıstığı kremalı kruvasan, beyaz çikolata parçaları' },
    'nutella-ganache': { name: 'Nutella Ganache', desc: 'Nutella ve bitter çikolata ganajlı kruvasan, pudra şekeri' },
    'blueberry-lemon': { name: 'Blueberry Lemon', desc: 'Yaban mersinli ve limonlu kruvasan, taze meyve sosu' },
    'filtre-kahve': { name: 'Filter Coffee', desc: 'Özel kavrum çekirdek, V60 demleme' },
    'americano': { name: 'Americano', desc: 'Double shot espresso, sıcak su — yoğun aromalı' },
    'cappuccino': { name: 'Cappuccino', desc: 'Espresso, buharla ısıtılmış süt, yoğun süt köpüğü' },
  },
  en: {
    'english-breakfast': { name: 'English Breakfast', desc: 'Eggs, sausage, bacon, mushrooms, tomatoes, beans, toast' },
    'danish-boat': { name: 'Danish Boat', desc: 'Danish pastry boat, forest berries, almonds, powdered sugar' },
    'croissant-sandwich': { name: 'Croissant Sandwich', desc: '72-hour croissant sandwich, fresh ingredients' },
    'fresh': { name: 'Fresh Bowl', desc: 'Seasonal fruits, granola, yogurt, honey' },
    'pistachio-croissant': { name: 'Pistachio Croissant', desc: 'Pistachio cream croissant, white chocolate chips' },
    'nutella-ganache': { name: 'Nutella Ganache', desc: 'Nutella & dark chocolate ganache croissant, powdered sugar' },
    'blueberry-lemon': { name: 'Blueberry Lemon', desc: 'Blueberry & lemon croissant, fresh fruit sauce' },
    'filtre-kahve': { name: 'Filter Coffee', desc: 'Specialty beans, V60 pour-over' },
    'americano': { name: 'Americano', desc: 'Double shot espresso, hot water — bold aroma' },
    'cappuccino': { name: 'Cappuccino', desc: 'Espresso, steamed milk, dense milk foam' },
  },
};
