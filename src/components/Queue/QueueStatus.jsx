          ...
          <motion.div variants={dramaticReveal} initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <div className="flex gap-4 mb-5">
              ...
              <div className="grid grid-cols-2 gap-3 flex-1">
                {[{ label: 'M4 Kadıköy', dist: '8 dk yürüme' },{ label: 'Kadıköy İskele', dist: '10 dk yürüme' },{ label: 'Moda Caddesi', dist: '1 dk yürüme' },{ label: 'Moda Sahil', dist: '3 dk yürüme' }].map((item) => (
